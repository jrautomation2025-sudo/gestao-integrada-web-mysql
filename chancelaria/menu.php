...
<body>
    ...
    <div class="mobile-topbar">
        <div class="d-flex align-items-center">
            ...
            <span style="font-family: 'Cinzel', serif; color: #f5c041; font-weight: bold;">CHANCELARIA</span>
        </div>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <i class="fas fa-book-open d-block mb-2 text-center" style="font-size: 1.8rem;"></i>
            Gestão de<br>Chancelaria
        </div>
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="sessoes" class="<?= ($paginaAtual == 'sessoes') ? 'active' : '' ?>"><i class="fas fa-calendar-alt"></i> Sessões</a></li>
        </ul>

        <div class="sidebar-section">Cadastros</div>
        <ul class="sidebar-nav">
            <li><a href="obreiros" class="<?= ($paginaAtual == 'obreiros') ? 'active' : '' ?>"><i class="fas fa-users"></i> Obreiros</a></li>
            <li><a href="obreiros_detalhes" class="<?= ($paginaAtual == 'obreiros_detalhes') ? 'active' : '' ?>"><i class="fas fa-address-book"></i> Informações</a></li>
        </ul>

        <div class="sidebar-section">Ferramentas</div>
        <ul class="sidebar-nav">
            <li><a href="presenca" class="<?= ($paginaAtual == 'presenca') ? 'active' : '' ?>"><i class="fas fa-check-square"></i> Presenças</a></li>
            <li><a href="visitantes" class="<?= ($paginaAtual == 'visitantes') ? 'active' : '' ?>"><i class="fas fa-id-badge"></i> Visitantes</a></li>
        ...
        <ul class="sidebar-nav">
            <li><a href="aniversariantes" class="<?= ($paginaAtual == 'aniversariantes') ? 'active' : '' ?>"><i class="fas fa-birthday-cake"></i> Aniversariantes</a></li>
            <li><a href="relatorios" class="<?= ($paginaAtual == 'relatorios') ? 'active' : '' ?>"><i class="fas fa-print"></i> Relatórios</a></li>
            <li><a href="modelo_certificado" class="<?= ($paginaAtual == 'modelo_certificado') ? 'active' : '' ?>"><i class="fa-solid fa-eye"></i> Veja o Certificado</a></li>
            <li><a href="informacoes" class="<?= ($paginaAtual == 'informacoes') ? 'active' : '' ?>"><i class="fa-solid fa-triangle-exclamation"></i> Importante</a></li>
            <li>

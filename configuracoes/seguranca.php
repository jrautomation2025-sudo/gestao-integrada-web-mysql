...
session_start();
require 'config.php';
require './utils/GoogleAuthenticator.php'; // Caminho correto para a classe
...
<body>
    ...
    <a href="logout" class="btn-voltar">
    ...
    <div class="container-fluid py-5 px-4">
        ...
        <div>
            <h3 class="fw-bold m-1 text-white">Segurança 2FA</h3>
            <small style="color: #cfa34e;">Configure seu duplo fator de segurança</small>
        </div>
        </br>

...
<head>
    ...
    <title>Secretaria - Modelo do Convite</title>
...
<div class="mobile-topbar">
    ...
    <span class="text-white small">Modelo de Convite</span>
</div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 style="font-family: 'Cinzel', serif; font-weight: 700; color: white; font-size: 1.8rem;">
                <i class="fas fa-eye text-warning me-2"></i> Modelo do Convite Oficial
            </h2>
            <p class="text-warning mb-0">Visualize o layout do convite que será gerado e enviado aos Irmãos.</p>
        </div>
        <a href="convites" class="btn btn-outline-warning">
            <i class="fas fa-arrow-left me-2"></i> Voltar para Disparo
        </a>
    </div>
    ...
    <div class="card-custom text-center">
        <div class="mb-4">
            <p class="text-muted small">
                <i class="fas fa-info-circle me-1"></i> Os dados como Nome da Loja, Datas, Horários e Assinaturas serão substituídos dinamicamente pelo sistema no momento do envio.
            </p>
        </div>
        
        <!-- IMAGEM DE PREVIEW -->
        <!-- Substitua 'modelo_convite.png' pelo nome exato do arquivo que você subiu -->
        <img src="modelo_convite.png" alt="Preview do Convite" class="preview-imagem">
        
        <div class="mt-4">
            <a href="convites" class="btn btn-warning btn-lg px-5">
                <i class="fas fa-paper-plane me-2"></i> Ir para Disparo de Convite
            </a>
        </div>
    </div>
</main>

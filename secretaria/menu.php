...
<body>
    ...
    <div class="mobile-topbar">
        <div class="d-flex align-items-center">
            ...
            <span style="font-family: 'Cinzel', serif; color: #f5c041; font-weight: bold;">SECRETARIA</span>
        </div>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            <li><a href="balaustres" class="<?= ($paginaAtual == 'balaustres') ? 'active' : '' ?>"><i class="fas fa-file-alt"></i> Balaustres</a></li>
            <li><a href="expedientes" class="<?= ($paginaAtual == 'expedientes') ? 'active' : '' ?>"><i class="fas fa-paper-plane"></i> Expedientes</a></li>
            <li><a href="corresp" class="<?= ($paginaAtual == 'corresp') ? 'active' : '' ?>"><i class="fas fa-inbox"></i> Correspondências</a></li>
            <li><a href="inventario" class="<?= ($paginaAtual == 'inventario') ? 'active' : '' ?>"><i class="fas fa-boxes"></i> Inventário</a></li>
            <li><a href="lojas" class="<?= ($paginaAtual == 'lojas') ? 'active' : '' ?>"><i class="fas fa-landmark me-2"></i> Lojas</a></li>
        </ul>
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="convites" class="<?= ($paginaAtual == 'convites') ? 'active' : '' ?>"><i class="fa-solid fa-users-gear"></i> Convites</a></li>
        </ul>
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="modelo_convite" class="<?= ($paginaAtual == 'modelo_convite') ? 'active' : '' ?>"><i class="fa-solid fa-eye"></i> Veja o Convite</a></li>
            <li>

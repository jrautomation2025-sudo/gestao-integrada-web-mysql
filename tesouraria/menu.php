...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            <i class="fas fa-coins d-block mb-2 text-center" style="font-size: 1.8rem;"></i>
            Gestão de<br>Tesouraria
        </div>

        <div class="sidebar-section">Menu Principal</div>
        <ul class="sidebar-nav">
            <li><a href="inicio" class="<?= ($paginaAtual == 'inicio') ? 'active' : '' ?>"><i class="fas fa-chart-pie"></i> Dashboard</a></li>
            <li><a href="investimentos" class="<?= ($paginaAtual == 'investimentos') ? 'active' : '' ?>"><i class="fas fa-money-bill-trend-up"></i> Investimentos</a></li>
            
        </ul>

        <div class="sidebar-section">Cadastros</div>
        <ul class="sidebar-nav">
            <li><a href="membros" class="<?= ($paginaAtual == 'membros') ? 'active' : '' ?>"><i class="fas fa-users"></i> Membros</a></li>
            <li><a href="locatario" class="<?= ($paginaAtual == 'locatario') ? 'active' : '' ?>"><i class="fa-solid fa-building-user"></i> Locatários</a></li>
        </ul>

        <div class="sidebar-section">Ferramentas</div>
        <ul class="sidebar-nav">
            <li><a href="mensalidades" class="<?= ($paginaAtual == 'mensalidades') ? 'active' : '' ?>"><i class="fas fa-table"></i> Mensalidades</a></li>
            <li><a href="alugueis_templo" class="<?= ($paginaAtual == 'alugueis_templo') ? 'active' : '' ?>"><i class="fas fa-building"></i> Alugueis</a></li>
            <li><a href="transacoes" class="<?= ($paginaAtual == 'transacoes') ? 'active' : '' ?>"><i class="fas fa-bars"></i> Transações</a></li>
            <li><a href="mensagens" class="<?= ($paginaAtual == 'mensagens') ? 'active' : '' ?>"><i class="fab fa-whatsapp"></i> Mensagens</a></li>
        </ul>

        <div class="sidebar-section">Informações</div>
        <ul class="sidebar-nav">
            <li><a href="relatorios" class="<?= ($paginaAtual == 'relatorios') ? 'active' : '' ?>"><i class="fas fa-file-invoice-dollar"></i> Relatórios</a></li>
            <li><a href="config_pix" class="<?= ($paginaAtual == 'config_pix') ? 'active' : '' ?>"><i class="fa-brands fa-pix"></i> Configurações</a></li>
            <li><a href="agendamentos_tesouraria" class="<?= ($paginaAtual == 'agendamentos_tesouraria') ? 'active' : '' ?>"><i class="fa-solid fa-clock"></i> Agendamentos</a></li>
            <li>
